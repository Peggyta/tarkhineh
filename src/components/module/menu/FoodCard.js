...
const FoodCard = ({data}) => {
    ...
    return (
        <div className='flex border border-bordercolor rounded-md w-600 gap-6 '>
            <div>
            ...
            <div className='pt-1 pb-2 flex flex-col justify-between'>
                ...
                <div className='flex items-center justify-between'>
                    ...
                    <button className='bg-primary rounded-md text-white w-56 pt-1 pb-2'>افزودن به سبد خرید</button>
                </div> 
            </div>
