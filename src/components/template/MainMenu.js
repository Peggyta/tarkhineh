...
const MainMenu = ({foodData}) => {
        ...
        <div>
            ...
            <div className='w-full bg-ash'>
                <div className='text-neutral md:px-12 px-4 flex md:gap-7 gap-4 pb-4 pt-3 sm:text-xl text-base font-bold '>
            ...
            <div className='grid md:grid-cols-2 grid-cols-1 place-items-center gap-6 py-8 '>
                {foodData.length ? (
                    foodData.map((food)=> {
                        return(
